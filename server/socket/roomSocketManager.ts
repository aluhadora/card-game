...
import type { StartGamePayload, RoomJoinPayload } from '../types.d.ts';
...
export default class RoomSocketManager {
  ...
  public attach() {
    ...
    this.io.on('connection', (socket: Socket) => {
      ...
      socket.on('player-move', (data: PlayerMovePayload) => this.handlePlayerMove(socket, data));
  ...
  private handlePlayerMove(socket: Socket, data: PlayerMovePayload) {
